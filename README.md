...
[https://ys200501266-design.github.io/AI-Smart-Reminder-App/](https://ys200501266-design.github.io/AI-Smart-Reminder-App/)

说明：Web Demo 已支持添加到手机主屏幕，用于作品集长期展示，不依赖本地电脑开机。React Native / Expo 真机版代码仍在 `src/` 中，Web Demo 静态文件位于 `web-demo/`。
...
- iPhone Safari：打开 Demo 链接，点击分享按钮，选择“添加到主屏幕”。
- Android Chrome / Edge：打开 Demo 链接，点击右上角菜单，选择“添加到主屏幕”或“安装应用”。
- 添加后，手机桌面会出现“AI 智能提醒助手”图标，之后可以像 App 一样打开。
...
- Web Demo / PWA 适合长期展示，但浏览器会限制后台定时器。需要锁屏通知时，请使用 Android APK。
